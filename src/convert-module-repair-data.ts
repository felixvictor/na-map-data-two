...
import { getCommonPaths, readTextFile, saveJsonAsync } from "./common"
import type { TextEntity, XmlRepair } from "./@types/xml"
import type { Repair, RepairAmount } from "./@types/repairs"
